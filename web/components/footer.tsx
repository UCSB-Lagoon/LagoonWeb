      ...
      <div className="max-w-7xl mx-auto px-5 pt-12 pb-8 grid gap-10 md:grid-cols-4 text-sm">
        <div>
          <div className="flex items-center gap-2">
            <span
              aria-hidden="true"
              className="grid place-items-center w-8 h-8 rounded-lg bg-gradient-to-br from-amber-400 to-orange-500 text-white font-display font-extrabold text-lg leading-none shadow-[0_6px_18px_-8px_rgba(0,54,96,0.7)]"
            >
              L
            </span>
